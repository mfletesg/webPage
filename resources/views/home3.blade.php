    ...
    <section class="jumbotron text-center h-100 jumbotron-about">
      <div class="container">
        <div class="container-about">
          ...
          <p>I'm <span class="typed" id="textAbout" data-typed-items="❤️ Open Source, UI/UX Designer , Developer Laravel, Developer Vtex.IO, Developer IONIC, Developer React, Photographer"></span></p>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <h2>About</h2>
                  ...
                  <img src="{{URL::asset('img/PSX_20191026_045117.jpg')}}" alt="Photo 1" class="img-fluid">
