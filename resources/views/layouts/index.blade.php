	...
	<head>
	  ...
	  @else
	    ...
	    <link rel="stylesheet" href="{{secure_asset('plugins/fontawesome-free/css/all.min.css')}}">
	  	...
	  	<link rel="stylesheet" href="{{secure_asset('css/home.css?v=1.0.5')}}">
        ...
        <script src="{{secure_asset('js/home.js?version=1.0.5')}}" type="text/javascript"></script>
        <script src="{{secure_asset('js/s.js?version=1.0.5')}}" type="text/javascript"></script>
	@endif
