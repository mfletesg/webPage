...
<body>
	...
	@yield('content')
   	...
   	<script src="{{URL::asset('assets/vendor/purecounter/purecounter.js')}}" type="text/javascript"></script>
   	<script src="{{URL::asset('assets/vendor/aos/aos.js')}}" type="text/javascript"></script>
   	<script src="{{URL::asset('assets/vendor/bootstrap/js/bootstrap.bundle.min.js')}}" type="text/javascript"></script>
