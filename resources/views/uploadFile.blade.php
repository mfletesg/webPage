  ...
  <button class="bubbly-button" onclick="principalPage()"><span>Ir a pagina principal</span></button>
    ...
    <form class="form-container" enctype='multipart/form-data'>
        <div class="upload-files-container">
            <div class="drag-file-area">
                ...
                <h3 class="dynamic-message">Arrastra tu archivo CSV</h3>
                <label class="label"><span class="browse-files"> 

                    <input type="file" class="default-file-input" name="fileXML" id="inputFile" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"/>
                    
                    <br>
                    <span>o con el </span><span class="browse-files-text">explorador de archivos</span>  </span> </label>
            </div>
    ...
    <script>
        ...
        removeFileButton.addEventListener("click", () => {
            ...
            document.querySelector(".label").innerHTML = `<span>o con el </span><span class="browse-files"> <input type="file" class="default-file-input"/ <span class="browse-files-text">explorador de archivos</span>  </span> </label>`;
